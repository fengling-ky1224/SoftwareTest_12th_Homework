...
class Unet(nn.Module):
    def __init__(self, filters, drop_r=0.5, use_attention=False):  # 新增 use_attention 参数
        ...
        # 启用 Attention 的设置
        self.up1 = um.Up_Block(filters * 16, filters * 8, drop_r, attention=use_attention)
        self.up2 = um.Up_Block(filters * 8, filters * 4, drop_r, attention=use_attention)
        self.up3 = um.Up_Block(filters * 4, filters * 2, drop_r, attention=use_attention)
        self.up4 = um.Up_Block(filters * 2, filters, drop_r, attention=use_attention)
