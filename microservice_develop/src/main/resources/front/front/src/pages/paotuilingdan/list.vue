...
<div>
    ...
    <el-form :inline="true" :model="formSearch" class="list-form-pv" :style='{"padding":"30px 10px 0","alignItems":"center","flexWrap":"wrap","background":"none","display":"flex","width":"100%","height":"auto"}'>
      <el-form-item :style='{"alignItems":"center","margin":"0 4px 0 0","display":"flex"}'>
		<div class="lable" v-if="false" :style='{"width":"auto","padding":"0 10px","lineHeight":"42px"}'>订单状态</div>
        <el-select v-model="formSearch.dingdanzhuangtai" placeholder="请选择订单状态" :clearable="true">
          <el-option v-for="(item, index) in dingdanzhuangtaiOptions" :key="index" :label="item" :value="item"></el-option>
        </el-select>
      </el-form-item>
      <el-form-item :style='{"alignItems":"center","margin":"0 4px 0 0","display":"flex"}'>
      ...
      <el-form-item :style='{"alignItems":"center","margin":"0 4px 0 0","display":"flex"}'>
	    <div class="lable" v-if="false" :style='{"width":"auto","padding":"0 10px","lineHeight":"42px"}'>领取账号</div>
        <el-input v-model="formSearch.lingquzhanghao" placeholder="领取账号" clearable></el-input>
      </el-form-item>
	  ...
	  <el-button v-if="isAuth('paotuilingdan','新增')" :style='{"cursor":"pointer","padding":"0px 10px","margin":"0 4px 0 0","borderColor":"#fda100","color":"#fda100","outline":"none","borderRadius":"4px","background":"#fcf2e1","borderWidth":"1px 4px","width":"auto","fontSize":"14px","lineHeight":"42px","borderStyle":"solid","height":"42px"}' type="primary" @click="add('/index/paotuilingdanAdd')"><i v-if="true" :style='{"color":"#fda100","margin":"0 10px 0 0","fontSize":"14px"}' class="el-icon-circle-plus-outline"></i>添加</el-button>
    </el-form>
  ...
  export default {
    ...
    methods: {
      ...
      getList(page, fenlei, ref = '') {
        ...
        let searchWhere = {};
        if (this.formSearch.dingdanzhuangtai != '') searchWhere.dingdanzhuangtai = this.formSearch.dingdanzhuangtai;
        if (this.formSearch.zhanghao != '') searchWhere.zhanghao = '%' + this.formSearch.zhanghao + '%';
        if (this.formSearch.lingquzhanghao != '') searchWhere.lingquzhanghao = '%' + this.formSearch.lingquzhanghao + '%';
        this.$http.get('paotuilingdan/list', {params: Object.assign(params, searchWhere)}).then(res => {
          if (res.data.code == 0) {
      ...
      toDetail(item) {
        this.$router.push({path: '/index/paotuilingdanDetail', query: {detailObj: JSON.stringify(item)}});
      },
    }
  }
</script>
