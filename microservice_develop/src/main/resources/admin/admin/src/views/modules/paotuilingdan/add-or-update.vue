	...
	<div class="addEdit-block" :style='{"minHeight":"100vh","padding":"30px","background":"url(http://codegen.caihongy.cn/20230329/eff4ea96c952463cb46b9c79d043ce56.gif) fixed,#f6f6f6"}' style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="费用" prop="paotuifeiyong">
					<el-input v-model="ruleForm.paotuifeiyong" placeholder="费用" clearable  :readonly="ro.paotuifeiyong"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="费用" prop="paotuifeiyong">
					<el-input v-model="ruleForm.paotuifeiyong" placeholder="费用" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="select" v-if="type!='info'"  label="订单状态" prop="dingdanzhuangtai">
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="订单状态" prop="dingdanzhuangtai">
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="领取账号" prop="lingquzhanghao">
					<el-input v-model="ruleForm.lingquzhanghao" placeholder="领取账号" clearable  :readonly="ro.lingquzhanghao"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="领取账号" prop="lingquzhanghao">
					<el-input v-model="ruleForm.lingquzhanghao" placeholder="领取账号" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="领取人" prop="lingquren">
					<el-input v-model="ruleForm.lingquren" placeholder="领取人" clearable  :readonly="ro.lingquren"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="领取人" prop="lingquren">
					<el-input v-model="ruleForm.lingquren" placeholder="领取人" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="date" v-if="type!='info'" label="领取时间" prop="lingqushijian">
					<el-date-picker
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-else-if="ruleForm.lingqushijian" label="领取时间" prop="lingqushijian">
					<el-input v-model="ruleForm.lingqushijian" placeholder="领取时间" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="date" v-if="type!='info'" label="预送达时间" prop="yusongdashijian">
					<el-date-picker
						value-format="yyyy-MM-dd HH:mm:ss"
						v-model="ruleForm.yusongdashijian" 
						type="datetime"
						:readonly="ro.yusongdashijian"
						placeholder="预送达时间"
					></el-date-picker>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-else-if="ruleForm.yusongdashijian" label="预送达时间" prop="yusongdashijian">
					<el-input v-model="ruleForm.yusongdashijian" placeholder="预送达时间" readonly></el-input>
				</el-form-item>
			</template>
	...
	methods: {
		...
		init(id,type) {
			...
			if(this.type=='info'||this.type=='else'){
				...
				this.ruleForm.dingdanzhuangtai='进行中'
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `paotuilingdan/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.paotuilingdanCrossAddOrUpdateFlag = false;
						 this.parent.search();
