	...
	<div class="addEdit-block" :style='{"minHeight":"100vh","padding":"30px","background":"url(http://codegen.caihongy.cn/20230329/eff4ea96c952463cb46b9c79d043ce56.gif) fixed,#f6f6f6"}' style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="select" v-if="type!='info'"  label="商品类型" prop="shangpinleixing">
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="商品类型" prop="shangpinleixing">
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="原价" prop="yuanjia">
					<el-input v-model="ruleForm.yuanjia" placeholder="原价" clearable  :readonly="ro.yuanjia"></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else-if="ruleForm.shangpinjieshao" label="商品介绍" prop="shangpinjieshao">
                    <span :style='{"fontSize":"16px","lineHeight":"40px","color":"#333","fontWeight":"500","display":"inline-block"}' v-html="ruleForm.shangpinjieshao"></span>
                </el-form-item>
...
export default {
    ...
    info(id) {
      this.$http({
        ...
        this.ruleForm.shangpinjieshao = this.ruleForm.shangpinjieshao.replace(reg,'../../../springboot1jxhb/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
